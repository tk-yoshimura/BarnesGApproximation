    ...
    internal class Program {
        static void Main() {
            ...
            while (!sr.EndOfStream) {
                ...
                MultiPrecision<Pow2.N32> x = line_split[0], y = line_split[2];

                expecteds.Add((x, y));
            }

            using StreamWriter sw_result = new("../../../../results_disused/log_barnes_g_e32_pade.csv");

            foreach ((double xmin, double x0, double xmax) in new[] { (0.25, 0.25, 0.75), (0.75, 1, 1.25), (1.25, 1.25, 1.75), (1.75, 2, 2.25), (2.25, 2.25, 2.75), (2.75, 3, 3.25) }) {
